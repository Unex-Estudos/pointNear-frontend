...
export function CategoryChip({
  ...
  `${category.color} ring-2 ring-offset-2 ring-offset-cream ring-current shadow-sm` :
  'bg-white text-charcoal-light hover:bg-moss-50 hover:text-moss border border-moss/10 hover:border-moss/30 shadow-sm';
  return (
    <button
      onClick={onClick}
      ...
      <IconComponent
        size={iconSizes[size]}
        className={isActive ? '' : 'text-moss-400'} />
