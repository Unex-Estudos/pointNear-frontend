    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
      ...
      <div className="flex items-center gap-6 mb-8 bg-white p-6 rounded-2xl shadow-sm border border-moss/10">
        <div className="text-center">
          <div className="text-4xl font-serif font-bold text-moss-900">{business.rating}</div>
          ...
          <div className="text-sm text-charcoal-light">{business.reviewCount} avaliações</div>
        </div>
      ...
      {!currentUserId ? (
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-moss/10 mb-6 text-center space-y-3">
          <p className="text-charcoal font-medium">Faça login para deixar uma avaliação</p>
          <p className="text-sm text-charcoal-light">Apenas usuários cadastrados podem avaliar estabelecimentos.</p>
          <button
