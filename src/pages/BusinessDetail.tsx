      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 md:-mt-16 relative z-10">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-float mb-8 border border-moss/5">
              ...
              <div className="hidden md:flex gap-4 border-t border-moss/10 pt-6">
                ...
                <button
                  ...
                  className="flex-1 bg-white dark:bg-dark-elevated border-2 border-moss-200 dark:border-dark-border hover:border-moss-300 disabled:opacity-50 text-moss-800 dark:text-dark-text py-3.5 rounded-xl font-medium flex items-center justify-center gap-2 transition-colors">
                  <Phone size={20} />
                  Ligar
                </button>
            ...
            {/* Tabs Navigation */}
            <div className="flex overflow-x-auto hide-scrollbar border-b border-moss/20 dark:border-dark-border mb-8 sticky top-16 bg-cream/90 dark:bg-dark-bg/90 backdrop-blur-md z-30 pt-2">
              {[
                {
                  id: "sobre",
                  label: "Sobre & Info",
                ...
                <button
                  ...
                  className={`px-6 py-4 text-sm font-medium whitespace-nowrap border-b-2 transition-colors ${activeTab === tab.id ? "border-terracotta text-terracotta" : "border-transparent text-charcoal-light dark:text-amber-100 hover:text-moss-700 dark:hover:text-amber-200"}`}>
                  {tab.label}
                </button>
              ))}
            </div>
              ...
              {activeTab === "avaliacoes" && (
                <motion.div
                  ...
                  <form
                    ...
                    className="bg-white p-5 rounded-2xl shadow-sm border border-moss/10 mb-6 space-y-4">
                    <h3 className="font-serif font-bold text-moss-900 text-lg">
                      Deixe sua avaliação
                    </h3>
                    {!user && (
                      <input
                        ...
                        onChange={(event) =>
                          setReviewAuthorName(event.target.value)
                        }
